...
export function Sidebar({ role }: SidebarProps) {
  ...
  const studentLinks = [
    ...
    { href: "/dashboard/courses", label: "My Courses", icon: BookIcon },
    { href: "/dashboard/assignments", label: "Assignments", icon: ClipboardIcon },
    { href: "/dashboard/quizzes", label: "Quizzes", icon: QuizIcon },
  ...
  const teacherLinks = [
    { href: "/dashboard", label: "Dashboard", icon: HomeIcon },
    { href: "/dashboard/courses", label: "My Courses", icon: BookIcon },
    { href: "/dashboard/courses/create", label: "Create Course", icon: PlusIcon },
